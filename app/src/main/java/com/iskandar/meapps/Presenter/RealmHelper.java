...
public class RealmHelper {
    ...
    public void update(final Integer id, final Integer nim, final String nama, final String kelas, final Integer telepon, final String email, final String sosmed){
